...
<html>
    ...
    <body>
        <h1>Welcome to the Concept of the Blob</h1>
        
        <a href="upload_page"><button>Click here to upload the Document</button></a>
        <br>
        <br>
        <a href="viewuploaddocuments"><button>Click here to View Document</button></a>
